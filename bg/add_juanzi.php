            	...
            	<div class="low">
            		<div class="col">
            			...
            			<div class="box_content">
            				<form action="ajax_add_juanzi.php" method="post" class="shiti_top">
            					<div class="form_group">
            						<label class="clo_sm">所属专业&nbsp;:</label>
            						<div class="clo_sm_2">
            							<select name="juanzi_zy" class="xi_tiku">
										...
										<span style="color: orange;">热门和课堂的专业都在一起</span>
            						</div>
            					</div>
            					<div class="form_group">
            						<label class="clo_sm">
            						...
            						<div class="clo_sm_2">
            							<input type="text" name="juanzi_name" value=""/>
            						</div>
            					</div>
            					<div class="form_group">
            						<label class="clo_sm">
            						...
            						<div class="clo_sm_2">
            							<input type="text" name="juanzi_shu" value=""/>
            						</div>
            					</div>
            					<div class="form_group">
            						<label class="clo_sm">
            						...
            						<div class="clo_sm_2">
            							<input readonly="readonly" type="text" name="juanzi_zuozhe" value="<?php echo $_SESSION['user']['username']?>"/>
            							<span style="color: orange;">作者标记为你本人，你无法修改</span>
            						</div>
            					</div>
            					<div class="form_group">
            						<div class="clo_sm_3">
		            					<input type="submit" value="开始编辑" class="shiti_tijiao" id="tijiao"/>
	            					</div>
            					</div>
            				</form>		
            			</div>
