<?php
	...
	$sql="select * from exam_hot order by exam_addtime desc limit ".(($pageNum-1)*$pageSize).",".$pageSize;
	$chaxun = $db->query($sql);
            	...
            	<div class="low">
            		<div class="col">
            			...
            			<div class="box_content">
            				...
            				<div class="seach_shiti">
            					<form action="seach_shiti.php" method="get">
            						...
            						<input type="hidden" name="shijuan" id="shijuan" value="2" />
            						<span class="ding">
            			...
            			<form action="delete_shiti.php" method="post">
            				<input type="hidden" value="2" name="biao_ji"/>
	            			<table class="table">
	            				<thead>
	            				...
	            				<tbody>
	            					<?php
	            						...
	            						<tr>
	            							...
	            							<td>
	            								<a href="bianji_shiti.php?biaoji=2&shiti_id=<?php echo $shiti_id?>">编辑</a>
	            								<a href="delete_danxuan.php?biaoji=2&shiti_id=<?php echo $shiti_id?>">删除</a>
	            							</td>
	            						</tr>
	            					<?}?>
	            				</tbody>
...
<script type="text/javascript">
	...
	add.onclick=function(){
		window.location.href='bianji_shiti.php?biaoji=2';
	}
</script>
</html>