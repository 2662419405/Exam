<?php
	...
	$sql="select * from user order by fans_num desc limit 10";
	$chaxun = $db->query($sql);
	$pai=0;
            					...
            					<tbody>
            						<?php
            							foreach($chaxun as $vo){
            								...
            								$yonghu_fen=$vo['fans_num'];//粉丝
            								$yonghu_guan=$vo['follows_num'];//粉丝
            								$yonghu_last=$vo['last_addtime'];//最近登录
            							?>
            							<tr>
	            							<td>
	            							...
	            							<td>
	            								<?php echo $yonghu_guan?>
	            							</td>
	            							<td>
	            								<?php echo date('Y-m-d',$yonghu_last)?>
	            							</td>
	            							<td>
