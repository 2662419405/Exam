<?php
	...
	$sql="select * from exam_zhuanye group by name order by exam_addtime desc limit ".(($pageNum-1)*$pageSize).",".$pageSize;
	$chaxun = $db->query($sql);
	$t=$db->query("select * from exam_zhuanye group by name");
	$toutal=sizeof($t);
