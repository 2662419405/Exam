<?php
	...
	$jinri_fang = $db->single("select count(*) from kong where addtime between :shijian and :jiezhi ",array('shijian'=>$todaystart,'jiezhi'=>$todayend));
			    ...
			    <div class="weibo_list">
			        <div class="weibo_list_top">
			            <div class="weibo_list_head">
			                <a href="<?php echo "geren.php?id=".$v['user_id'] ?>">
